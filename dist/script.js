...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])(".timer", "2020-12-30");
        ...
        switch (item.nodeName) {
          ...
          case "INPUT":
            if (item.getAttribute("type") === "checkbox") {
              i === 0 ? state[prop] = "Xолодное" : state[prop] = "Теплое";
...
var tabs = function tabs() {
  var createTabs = function createTabs(headerSelector, tabSelector, contentSelector, activeClass) {
